package com.alfahrel.toolbox.tiles
...
class CaffeineTileService : TileService() {
    ...
    companion object {
        ...
        const val ACTION_START_CAFFEINE = "com.alfahrel.toolbox.START_CAFFEINE"
        const val ACTION_STOP_CAFFEINE = "com.alfahrel.toolbox.STOP_CAFFEINE"
    }
